...
//		std::cout<<"It is going to create a client"<<std::endl;
		...
		this->host=gethostbyname("127.0.0.1");
...
//	printf("Data_Received in function receive_InfoClient(): %s, \nbytes= %d. \n",this->Data_Received,bytesReceived);	
	return returnValue;
}
...
std::string class_socket::receive_InfoClient_Variable()
{
	...
	this->Data_Received_Variable[bytesReceived]='\0';
	std::string returnValue=Data_Received_Variable;
//	printf("Data_Received in function receive_InfoClient_Variable(): %s, \nbytes= %d. \n",this->Data_Received_Variable,bytesReceived);	
	return returnValue;
}
...
std::string class_socket::receive_InfoServer()
{
	...
	Data_Received[bytesReceived]='\0';
	std::string returnValue=Data_Received;
//	printf("Data_Received in function receive_InfoServer(): %s, bytes= %d. \n",returnValue.data(),bytesReceived);	
	return returnValue;
}
...
//	printf("send_infoServer.. Data_to_Send: %s, \nbytesTosend= %d, Type.size() = %d. \n",Type.data(),bytesTosend,Type.size());	
	return bytesTosend;
}
