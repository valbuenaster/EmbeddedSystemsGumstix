...
void Relative2Global(double *Point, double *phi,double *POS_FR,double *result)
{
	result[0]=(Point[0]*cos(*phi))-(Point[1]*sin(*phi))+POS_FR[0];
	result[1]=(Point[0]*sin(*phi))+(Point[1]*cos(*phi))+POS_FR[1];
}

void Global2Relative(double *Point, double *phi,double *POS_FR,double *result)
{
	result[0]=(Point[0]*cos(*phi))+(Point[1]*sin(*phi))-((POS_FR[0]*cos(*phi))+(POS_FR[1]*sin(*phi)));
	result[1]=-(Point[0]*sin(*phi))+(Point[1]*cos(*phi))+(POS_FR[0]*sin(*phi))-(POS_FR[1]*cos(*phi));
}
